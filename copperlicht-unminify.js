...
CL3D.CopperLicht.prototype.handleKeyDown = function (c) {
    var e = this.getScene();
    if (e == null) {
        return
    }
    ...
    for (var b = 0; b < this.RegisteredAnimatorsForKeyUp.length; ++b) {
        if (this.RegisteredAnimatorsForKeyDown[b].onKeyDown(c)) {
            a = true
        }
    }
    return this.handleKeyPropagation(c, a)
};
CL3D.CopperLicht.prototype.handleKeyUp = function (c) {
    var e = this.getScene();
    if (e == null) {
        return
    }
    ...
    for (var b = 0; b < this.RegisteredAnimatorsForKeyUp.length; ++b) {
        if (this.RegisteredAnimatorsForKeyUp[b].onKeyUp(c)) {
            a = true
        }
    }
    return this.handleKeyPropagation(c, a)
};
CL3D.CopperLicht.prototype.handleKeyPropagation = function (b, a) {
    if (a) {
        try {
            b.preventDefault()
        } catch (c) {}
